...
2. During SDK initialization, configure your application's replay sample rate. 
   ...
   [4]: /real_user_monitoring/application_monitoring/session_replay/mobile/setup_and_configuration/?tab=ios
   {{% /tab %}}
   {{% tab "Android" %}}
   Follow [these steps][5] to setup and configure your mobile application's error replay for this platform.

   [5]: /real_user_monitoring/application_monitoring/session_replay/mobile/setup_and_configuration/?tab=android
   {{% /tab %}}
   {{% tab "Kotlin Multiplatform" %}}
   Follow [these steps][6] to setup and configure your mobile application's error replay for this platform.

   [6]: /real_user_monitoring/application_monitoring/session_replay/mobile/setup_and_configuration/?tab=kotlinmultiplatform
   {{% /tab %}}
   {{% tab "React Native" %}}
   Follow [these steps][7] to setup and configure your mobile application's error replay for this platform.

   [7]: /real_user_monitoring/application_monitoring/session_replay/mobile/setup_and_configuration/?tab=reactnative
   {{% /tab %}}
   {{</tabs>}}
